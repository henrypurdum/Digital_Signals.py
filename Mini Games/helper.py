...
#reset variables for damage
player_damage = init_player_damage
enemy_damage = init_enemy_damage
enemy_health = player_health_max - 1
...
while system == "on":
    ...
    while game == "on":
        ...
        while battle == "False":
            ...
            # when player types 'godmode'
            if exploreChoice == "godmode":
                print "Lol nope.\n"
                if charName == "Henry":
                    player_lvl = 100
                    print "Just kidding... As you command my liege.\n%s's Level: %s" % (charName, player_lvl)
    ...
    if game == "restart":
        system = "off"
        execfile("/Users/palihighcomputerclub/Desktop/Digital_Signals/PRPG_Mch_V.py")
